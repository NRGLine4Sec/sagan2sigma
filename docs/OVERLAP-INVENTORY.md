...
| `5013544` | [WINDOWS-SYSMON] Alternate Data Stream File Created | Metasploit SMB Authentication | `rules/windows/builtin/security/win_security_metasploit_authentication.yml` | 0.39 | a-za-z0-9 |
...
| `5013545` | [WINDOWS-SYSMON] Alternate Data Stream File Executed vi | Metasploit SMB Authentication | `rules/windows/builtin/security/win_security_metasploit_authentication.yml` | 0.38 | a-za-z0-9 |
